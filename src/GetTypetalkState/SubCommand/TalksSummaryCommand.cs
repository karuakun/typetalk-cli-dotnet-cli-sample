...
{
    [Command(TalksSummaryCommand.CommandName)]
    public class TalksSummaryCommand : SubCommandBase
    {
        public const string CommandName = "talkssummary";
        [Argument(0)]
